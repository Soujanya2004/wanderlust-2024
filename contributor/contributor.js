document.addEventListener("DOMContentLoaded", function () {
    const contributorsContainer = document.getElementById('contributorsGrid');
    ...
    async function fetchData() {
        ...
        try {
            const contributorsResponse = await axios.get('https://api.github.com/repos/Soujanya2004/wanderlust-2024/contributors');
            const contributorsData = contributorsResponse.data;

            const repoResponse = await axios.get('https://api.github.com/repos/Soujanya2004/wanderlust-2024');
